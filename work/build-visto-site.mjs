...
const homeRedesignCss = String.raw`<style id="visto-home-redesign">
  ...
  *{box-sizing:border-box}
  ...
  .mk-card img{width:100%;height:112px;object-fit:cover;display:block;background:#e8f1ed}
  ...
  .mk-price-bubble{position:absolute;left:10px;top:75px;background:rgba(6,36,29,.92);color:#fff;border:1px solid rgba(255,255,255,.18);border-radius:7px;padding:6px 8px;font-size:12px;font-weight:950;box-shadow:0 12px 26px -22px rgba(0,0,0,.9)}
  ...
  .mk-card-meta{display:flex;justify-content:space-between;align-items:center;gap:8px;color:var(--green2);font-size:12px;font-weight:950;border-top:1px solid #edf2ef;padding-top:8px}
  .mk-card-meta span{min-width:0;color:#527268;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  .mk-card-meta b{display:inline-flex;align-items:center;justify-content:center;min-height:26px;border-radius:999px;background:#EAF6EF;border:1px solid #CDEAE0;padding:0 10px;font-size:11px;color:var(--green2);white-space:nowrap}
  .mk-card:hover .mk-card-meta b{background:var(--green);border-color:var(--green);color:#fff}
