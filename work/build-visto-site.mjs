...
const homeRedesignCss = String.raw`<style id="visto-home-redesign">
  ...
  *{box-sizing:border-box}
  ...
  .mk-hero{position:relative;min-height:500px;background:center/cover no-repeat;color:#fff;display:grid;align-items:center;overflow:hidden}
  ...
  .mk-hero .mk-wrap{position:relative;width:100%;padding-top:42px;padding-bottom:42px;text-align:center}
  .mk-brandline{display:inline-flex;align-items:center;gap:8px;background:rgba(5,31,24,.58);border:1px solid rgba(255,255,255,.22);border-radius:999px;padding:8px 12px;font-size:12px;font-weight:900;margin-bottom:14px}
  .mk-brandline:before{content:"";width:8px;height:8px;border-radius:50%;background:var(--gold)}
  .mk-hero h1{font-size:44px;line-height:1.05;letter-spacing:0;margin:0 auto;max-width:840px;text-wrap:balance}
  .mk-hero p{font-size:16px;line-height:1.55;color:#e1f1eb;max-width:760px;margin:13px auto 20px}
  .mk-search{max-width:760px;margin:0 auto;background:rgba(255,255,255,.88);backdrop-filter:blur(16px);border:1px solid rgba(255,255,255,.58);border-radius:10px;box-shadow:0 26px 70px -42px rgba(0,0,0,.8);padding:12px;color:var(--ink)}
  .mk-tabs{display:flex;justify-content:center;gap:8px;margin-bottom:10px;flex-wrap:wrap}
  .mk-tab{height:30px;padding:0 12px;border:0;border-bottom:3px solid transparent;background:transparent;color:#5a6e67;font:inherit;font-size:12px;font-weight:900;cursor:pointer}
  ...
  .mk-field{height:52px;background:#fff;border:1px solid #dce6e1;border-radius:8px;padding:8px 13px;text-align:left}
  ...
  .mk-submit{height:52px;border-radius:8px;border:0;background:var(--green);color:#fff;font-weight:950;padding:0 20px;cursor:pointer;box-shadow:0 15px 28px -22px rgba(18,169,126,.9)}
  .mk-submit:hover{background:var(--green2)}
  .mk-quick{display:flex;justify-content:center;gap:8px;flex-wrap:wrap;margin-top:10px}
  ...
  .mk-head{display:flex;justify-content:space-between;gap:24px;align-items:end;margin-bottom:16px}
  .mk-k{font-size:12px;text-transform:uppercase;font-weight:950;letter-spacing:.06em;color:var(--green);margin-bottom:8px}
  .mk-h2{font-size:28px;line-height:1.15;letter-spacing:0;margin:0;color:var(--ink)}
  .mk-sub{font-size:14px;line-height:1.6;color:var(--soft);margin:7px 0 0;max-width:660px}
  ...
  @media(max-width:680px){.mk-hero{min-height:620px}.mk-hero .mk-wrap{padding-top:38px;padding-bottom:32px}.mk-hero h1{font-size:34px}.mk-hero p{font-size:15px}.mk-searchbar{grid-template-columns:1fr}.mk-submit{width:100%}.mk-stats-grid,.mk-card-grid,.mk-method-grid,.mk-city-grid,.mk-final-box{grid-template-columns:1fr}.mk-stat{border-left:0;border-top:1px solid var(--line)}.mk-head{display:block}.mk-link{display:inline-flex;margin-top:12px}.mk-feature-photo img{height:280px}.mk-row{grid-template-columns:1fr}.mk-final-box .mk-btn{width:100%}}
</style>`;
